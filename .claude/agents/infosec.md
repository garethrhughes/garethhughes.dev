---
name: infosec
description: Use for a security and compliance audit of staged changes or a PR — especially when the change touches auth, encryption, user data, IAM, logging, secrets, or external integrations. Read-only: produces a verdict, never edits files.
