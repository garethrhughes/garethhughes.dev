---
name: decision-log
description: Use to record an architectural or technical decision as an ADR in docs/decisions/. Triggered after a technology is chosen, a pattern adopted, a trade-off made, or a proposal accepted.
