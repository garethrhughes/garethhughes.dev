...
datePublished: Sat, 09 Dec 2023 01:00:00 GMT
...
<div data-node-type="callout-text">This post only gets you part way, it doesn’t update the stage when deploying - <a target="_self" rel="noopener noreferrer nofollow" href="https://garethrhughes.hashnode.dev/deploying-resources-into-shared-api-gateway-part-2" style="pointer-events: none">Deploying Resources Into Shared API Gateway - Part 2</a>&nbsp;</div>
</div>
